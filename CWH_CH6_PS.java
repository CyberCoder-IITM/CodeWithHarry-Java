public class CWH_CH6_PS {
    public static void main(String[] args) {
        ...
        // Practice Problem 3 - Calculate the average marks from an array containing
        ...
        // Practice Problem 4 - Create a Java program to add two matrices of size 2x3.
        int [][] mat1 = {{1, 2, 3},
                         {4, 5, 6}};
        int [][] mat2 = {{2, 6, 13},
                         {3, 7, 1}};
        ...
        // Practice Problem 6 - Write a Java program to find the maximum element in an array.
